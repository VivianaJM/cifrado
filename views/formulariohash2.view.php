...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info mb-5">
        ...
        <h4 class="h1 text-center text-success">Cifrado hash v2</h4><br>

        <div class="container fluid justify-content-center">            

            <form class="col-7 p-0 shadow-sm container fluid justify-content-center" action="../insertarusuario_hash2.php" method="POST">
        ...
        ?>
            ...
            <thead>
                ...
                <th scope="col">Contraseña cifrada hash v2</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                $sql="SELECT * FROM usuarioshash2";
                ...
                <td><?php echo $mostrar['contra_cif_hash2']?></td>
                </tr>
            </tbody>
            <?php
                }
