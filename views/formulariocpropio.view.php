...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-info mb-5">
        <div class="container justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link active fs-4 " aria-current="page" href="formulariocpropio.view.php">Cifrado propio</a>
            </li>
            </ul><br><br><br>
            </div>
        </div>
        </nav>
        <h4 class="h1 text-center text-success">Cifrado propio</h4><br>

        <div class="container fluid justify-content-center">            

            <form class="col-7 p-0 shadow-sm container fluid justify-content-center" action="../insertarusuario_cpropio.php" method="POST">
        ...
        ?>
            ...
            <thead>
                ...
                <th scope="col">Contraseña cifrada (método propio)</th>
                <th scope="col">Contraseña descifrada</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                $sql="SELECT * FROM usuarioscpropio";
                ...
                <td><?php echo $mostrar['contra_cif_propio']?></td>
